...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("", dateStrToDigit("-29 марта 1993"))
        assertEquals("", dateStrToDigit("29 марта -1993"))
    }
    ...
    fun dateDigitToStr() {
        ...
        assertEquals("", dateDigitToStr("03.04.-2011"))
        assertEquals("", dateDigitToStr("-03.04.2011"))
    ...
    fun bestHighJump() {
        ...
        assertEquals(-1, bestHighJump("226 ඞ"))
    ...
    fun firstDuplicateIndex() {
        ...
        assertEquals(2, firstDuplicateIndex("t a a a"))
    }
